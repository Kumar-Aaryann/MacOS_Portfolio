...
const socials = [
  {
    ...
    bg: "#f4656b",
    link: "https://github.com/Kumar-Aaryann",
  },
  {
    id: 2,
    text: "Email",
    icon: "/icons/atom.svg",
    bg: "#4bcb63",
    link: "https://kumar.aryan.3572@gmail.com",
  },
  {
    id: 3,
    text: "Twitter/X",
  ...
  },
  {
    ...
    bg: "#05b6f6",
    link: "https://www.linkedin.com/in/kumar-aaryan-859779249/",
  },
];
  ...
  children: [
    ...
    // ▶ Project 2
    {
      ...
      children: [
        {
          id: 1,
          name: "Gaming Website.txt",
          icon: "/images/txt.png",
          kind: "file",
          fileType: "txt",
          position: "top-5 right-10",
          description: [
            "This gaming platform brings together classic and modern games in one place. Users can explore a wide range of titles, discover new releases, and enjoy an easy-to-use, responsive experience built with modern web technologies.",
          ],
        },
        {
          id: 2,
          name: "Gaming Website.com",
          icon: "/images/safari.png",
          kind: "file",
          fileType: "url",
          href: "https://google.com",
